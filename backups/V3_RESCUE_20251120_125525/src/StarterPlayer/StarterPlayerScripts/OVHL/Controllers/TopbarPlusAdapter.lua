--[[ @Component: TopbarAdapter (Guaranteed Logger) ]]
...
function Adapter.New() 
    ...
    self._registry = {}
    -- GUARANTEE: Fallback logger
    self.Logger = require(RS.OVHL.Core.SmartLogger).New("TOPBAR")
    return self
end

function Adapter:Init(ctx)
    -- GUARANTEE: Gunakan ctx.Logger jika ada, otherwise keep fallback
